...
export const SlideContextProvider = ({ children }: SlideContextProps) => {
    ...
    const onTouchMove: React.TouchEventHandler<HTMLElement> = (e) => setTouchEnd(e.touches[0].clientX);
    ...
    return (
        <SlideContext.Provider value={{ slide, setSlide, touchStart, setTouchStart, touchEnd, setTouchEnd, onTouchStart, onTouchMove, onTouchEnd }}>
            {children}
